...
for point in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/madgraph/V5_2.6.5/sus_sms/SMS-C1N2/SMS-C1N2_mC1-%i_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz' % mn2),  
